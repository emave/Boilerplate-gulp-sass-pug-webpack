...
gulp.task('svgmin', (cb) => del(`${config.src.svgMin}/**/*.svg`).then(() => {
...
gulp.task('svgo:watch', () => gulp.watch(`${config.src.svgMin}/**/*.svg`, gulp.series('svgo')));
gulp.task('svgmin:watch', () => gulp.watch(`${config.src.svgSource}/**/*.svg`, gulp.series('svgmin')));
